...
typedef enum {
	...
	// 25 AA gap because I cant do addition.
	// T3 & T6 Stats
	aaInnateStrSta = 132,
	aaInnateStrAgi = 152,
	aaInnateStrDex = 172,
	...
	// T5 Passives
	aaFistsOfSteel = 678,
	aaRallosDestruction = 682,
	aaEnhancedRecovery = 686,
	aaDevestatingDestruction = 690,
	aaVeteransWrath	= 694,
	aaMentalFortitude = 698,
	aaMenagerieSpecialist = 702,
	aaWillOfTunare	= 706,
	aaQuickDraw		= 710,
	aaBlackguardsInitiative = 714,
	aaPhysicalEnhancement = 718,
	aaLessonOfTheWise = 722,
	aaQuickLearner	= 726,
	aaRot			= 730,
	aaMoralSupport	= 734,
	aaEmpoweringWill = 738,
	aaProtectionOfMithaniel = 742,
	aaTunaresOvergrowth = 746,
	aaJaggedIncantation = 750,
	aaDecayingOverkill = 754,
	aaBladedBlood	= 758,
	...
	aaRabidBear		= 771,
	aaBloodlust		= 772,
	aaFuryOfTheMadman = 773,
	aaMortalCoil	= 774,
	aaRazzleDazzle	= 775,
	aaDireStraights = 776,
	aaHalasImprovization = 777,
	aaPinpointAccuracy = 778,
	aaExplosionOfHate = 779,
	aaHostileTakeover = 780,
	aaRosFury		= 781,
	aaTheShowMustGoOn = 782,
	aaBlessingOfMarr = 783,
	aaManaHeist		= 784,
	aaShasReprisal	= 785,
	aaWarlordsTenacity = 786,
	aaFrenziedDevastation = 787,
	aaTheftOfSoul	= 788,
	aaBladeGuardian = 789,
