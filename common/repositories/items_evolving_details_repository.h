...
public:
     ...
     *
     * ItemsEvolvingDetailsRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * ItemsEvolvingDetailsRepository::GetWhereNeverExpires()
     * ItemsEvolvingDetailsRepository::GetWhereXAndY()
     * ItemsEvolvingDetailsRepository::DeleteWhereXAndY()
     *
