...
RULE_REAL(Skills, TradeskillNormalChance, 0, "Chance of producing a normal tradeskill item")
RULE_REAL(Skills, TradeskillUncommonChance, 0, "Chance of producing an uncommon tradeskill item")
RULE_REAL(Skills, TradeskillRareChance, 0, "Chance of producing a rare tradeskill item")
RULE_REAL(Skills, TradeskillEpicChance, 30.0, "Chance of producing an epic tradeskill item (30% probability)")
RULE_REAL(Skills, TradeskillLegendaryChance, 50.0, "Chance of producing a legendary tradeskill item (50% probability)")
RULE_REAL(Skills, TradeskillFabledChance, 20.0, "Chance of producing a fabled tradeskill item (20% probability)")
...
RULE_BOOL(Loot, LootRarityEnabled, true, "Enable or disable loot rarity system")
RULE_REAL(Loot, NormalDropChance, 20.0, "Drop chance for normal items")
RULE_REAL(Loot, UncommonDropChance, 20.0, "Drop chance for uncommon items")
RULE_REAL(Loot, RareDropChance, 20.0, "Drop chance for rare items")
RULE_REAL(Loot, EpicDropChance, 20.0, "Drop chance for epic items")
RULE_REAL(Loot, LegendaryDropChance, 20.0, "Drop chance for legendary items")
RULE_REAL(Loot, FabledDropChance, 20.0, "Drop chance for fabled items")
...
RULE_REAL(Loot, UncommonUpgradeChance, 20.0, "Drop chance for uncommon items")
...
RULE_REAL(StatBuff, CharismaPerTickDuration, 0.1, "This number * Charisma is a modifier on short spell duration (short being < 100 ticks)")
RULE_REAL(StatBuff, StrengthMaxHitPerLevel, 0.02, "This number * Strength * Level is a modifier to Max Hit.")
RULE_REAL(StatBuff, DexterityAccuracyPerLevel, 0.05, "This Number * Dexterity * Level is a modifier to accuracy.")
RULE_REAL(StatBuff, AgilityAvoidancePerLevel, 0.1, "This Number * Dexterity * Level is a modifier to avoidance.")
...
RULE_BOOL(AA, EnableLogrithmicClasslessAABonus, true, "Enables nearly instantanious 1,000 AAs to help players personalize their chartacter")
RULE_REAL(AA, InitialLogrithmicClasslessAABonus, 256.0, "The multiplier when AA count is 0")
RULE_REAL(AA, HalfLifeLogrithmicClasslessAABonus, 256.0, "How Many AAs before the initial bonus is cut in half")
RULE_REAL(AA, MinimumLogrithmicClasslessAABonus, 1.0, "How Many AAs before the initial bonus is cut in half")
RULE_CATEGORY_END()
