...
RULE_INT(Character, CorpseDecayTime, 900000, "Time after which the corpse decays (milliseconds) DEFAULT: 604800000 (7 Days)")
RULE_INT(Character, EmptyCorpseDecayTime, 900000, "Time after which an empty corpse decays (milliseconds) DEFAULT: 10800000 (3 Hours)")
RULE_INT(Character, CorpseResTime, 900000, "Time after which the corpse can no longer be resurrected (milliseconds) DEFAULT: 10800000 (3 Hours)")
RULE_INT(Character, DuelCorpseResTime, 900000, "Time before cant res corpse after a duel (milliseconds) DEFAULT: 600000 (10 Minutes)")
...
RULE_REAL(Character, ExpMultiplier, 1, "If greater than 0, the experience gained is multiplied by this value. ")
RULE_REAL(Character, AAExpMultiplier, 1, "If greater than 0, the AA experience gained is multiplied by this value. ")
RULE_REAL(Character, GroupExpMultiplier, 1, "The experience in a group is multiplied by this value in addition to the group multiplier. The group multiplier is: 2 members=x 1.2, 3=x1.4, 4=x1.6, 5=x1.8, 6=x2.16")
...
RULE_INT(Character, LightBlueModifier, 50, "The experience obtained for light-blue con mobs is multiplied by value/100")
RULE_INT(Character, BlueModifier, 100, "The experience obtained for blue con mobs is multiplied by value/100")
RULE_INT(Character, WhiteModifier, 130, "The experience obtained for white con mobs is multiplied by value/100")
RULE_INT(Character, YellowModifier, 175, "The experience obtained for yellow con mobs is multiplied by value/100")
RULE_INT(Character, RedModifier, 350, "The experience obtained for red con mobs is multiplied by value/100")
RULE_INT(Character, AutosaveIntervalS, 30, "Number of seconds after which a timer is triggered which stores the character data. The value 0 means no periodic automatic saving.")
...
RULE_INT(Character, HasteCap, 1000, "Haste cap for non-v3(over haste) haste")
RULE_INT(Character, Hastev3Cap, 250, "Haste cap for v3(over haste) haste")
...
RULE_INT(Character, MaxFearDurationForPlayerCharacter, 3, "Maximum number of tics a player can be feared. 1 tic equls 6 seconds")
RULE_INT(Character, MaxCharmDurationForPlayerCharacter, 10, "Maximum number of tics a player can be charmed. 1 tic equls 6 seconds")
...
RULE_BOOL(Character, RespawnFromHover, true, "Setting whether the respawn window should be used")
RULE_INT(Character, RespawnFromHoverTimer, 900, "Respawn Window countdown timer, in seconds")
...
RULE_INT(Character, BaseRunSpeedCap, 225, "Base Run Speed Cap, on live it's 158% which will give you a runspeed of 1.580 hard capped to 225")
...
RULE_REAL(Character, TradeskillUpAlchemy, 1.0, "Alchemy skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpBaking, 1.0, "Baking skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpBlacksmithing, 1.0, "Blacksmithing skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpBrewing, 1.0, "Brewing skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpFletching, 1.0, "Fletching skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpJewelcrafting, 1.0, "Jewelcrafting skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpMakePoison, 1.0, "Make Poison skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpPottery, 1.0, "Pottery skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpResearch, 1.0, "Research skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpTinkering, 1.0, "Tinkering skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpTailoring, 1.0, "Tailoring skillup rate adjustment. Lower is faster")
...
RULE_INT(Character, SkillUpMaximumChancePercentage, 70, "Maximum chance to improve a combat skill, before skill-specific modifiers.  This should be greater than SkillUpMinimumChancePercentage.")
RULE_INT(Character, SkillUpMinimumChancePercentage, 25, "Minimum chance to improve a combat skill, after skill-specific modifiers.  This should be lesser than SkillUpMaximumChancePercentage.")
...
RULE_REAL(Character, GroupMemberEXPModifier, 1, "Sets the group experience modifier per members between 2 and 5, default is 0.2")
RULE_REAL(Character, FullGroupEXPModifier, 7, "Sets the group experience modifier for a full group, default is 2.16")
RULE_BOOL(Character, IgnoreLevelBasedHasteCaps, true, "Ignores hard coded level based haste caps.")
...
RULE_BOOL(Character, LeaveCursorMoneyOnCorpse, true, "Enable or disable leaving cursor money on player corpses")
RULE_BOOL(Character, ItemExtraSkillDamageCalcAsPercent, true, "If enabled, apply Item Extra Skill Damage as Percentage-based modifiers")
RULE_BOOL(Character, UseForageCommonFood, true, "If enabled, use the common foods specified in the code.")
RULE_INT(Character, ClearXTargetDelay, 0, "Seconds between uses of the #clearxtargets command (Set to 0 to disable)")
...
RULE_INT(Character, MendAlwaysSucceedValue, 100, "Value at which mend will always succeed its skill check. Default: 199")
...
RULE_BOOL(Skills, UseLimitTradeskillSearchSkillDiff, false, "Enables the limit for the maximum difference between trivial and skill for recipe searches and favorites")
...
RULE_BOOL(Skills, TrainSenseHeading, true, "Switch whether SenseHeading is trained by use")
RULE_INT(Skills, SenseHeadingStartValue, 0, "Start value of sense heading skill")
...
RULE_BOOL(World, EnableIPExemptions, true, "If true, ip_exemptions table is used, if there is no entry for the IP it will default to RuleI(World, MaxClientsPerIP)")
...
RULE_CATEGORY(Loot)
RULE_REAL(Loot, LootPinyataChance, 20.5, "Chance to add 1 to drop limit on each roll, up to LootPinyataMax")
RULE_INT(Loot, LootPinyataMax, 12, "Maximum number of additional loot drops allowed by LootPinyataChance, Set to 0 or -1 to disable")
RULE_INT(Loot, MaxFabledDrop, 3, "Maximum number of fabled items that can drop from a single loot event")
RULE_INT(Loot, MinFabledDropRaidTarget, 1, "Minimum number of fabled items that must drop from a raid target")
RULE_BOOL(Loot, LootRarityEnabled, false, "Enable or disable loot rarity system")
RULE_BOOL(Loot, UpgradeEquipmentEnabled, true, "Enable or Disable higher rarity results of Upgrade Equipment AA.")
RULE_BOOL(Loot, UpgradeEpicsToFabledEnabled, true, "Enable or Disable Epic Items automatically becoming Fabled.")
RULE_REAL(Loot, NormalUpgradeChance, 0.0, "Drop chance for normal items")
RULE_REAL(Loot, RareUpgradeChance, 20.0, "Drop chance for rare items")
RULE_REAL(Loot, EpicUpgradeChance, 20.0, "Drop chance for epic items")
RULE_REAL(Loot, LegendaryUpgradeChance, 20.0, "Drop chance for legendary items")
RULE_REAL(Loot, FabledUpgradeChance, 20.0, "Drop chance for fabled items")
RULE_CATEGORY_END()


RULE_CATEGORY(StatBuff)
RULE_BOOL(StatBuff, StatBuffEnabled, true, "Enable or Disable Statbuffage.")
RULE_INT(StatBuff, StatSoftcap, 255, "Sets the softcap where stat's impact is lowered.")
RULE_REAL(StatBuff, StatSoftcapReturns, 0.45, "Post softcap, how important is a stat? Returns * Stat")
RULE_REAL(StatBuff, CharismaDuration, 0.01, "This number * Charisma is a multiplier on total spell duration")
RULE_REAL(StatBuff, CharismaResistanceDebuff, 0.06, "This number * Charisma is a modifier to enemy resists")
RULE_REAL(StatBuff, CharismaPerTickDuration, 0.1, "This number * Charisma is a modifier on short spell duration (short being < 10 ticks)")
RULE_INT(StatBuff, CharismaLongBuffMinDuration, 10, "This number dictates what the definition of a short and long buff are in tics")
RULE_BOOL(StatBuff, CharismaBuffApplyToDisc, false, "Does charisma apply to disciplines?")
RULE_REAL(StatBuff, CharismaPetPowerAdded, 2.0, "How much does cha add to pet power?")
RULE_REAL(StatBuff, CharismaPetPowerMult, 0.5, "How much does cha multiply to pet power? (applied before additive pet power)")
RULE_REAL(StatBuff, StrengthMaxHitPerLevel, 0.02, "This number * Strength * Level is a modifier to Max Hit.")
RULE_REAL(StatBuff, DexterityAccuracyPerLevel, 0.0015, "This Number * Dexterity * Level is a modifier to accuracy.")
RULE_REAL(StatBuff, AgilityAvoidancePerLevel, 0.0005, "This Number * Dexterity * Level is a modifier to avoidance.")
RULE_REAL(StatBuff, IntelligenceManaRegenPerLevel, 0.025, "This Number * Intelligence * Level is a modifier to mana regen. I think I wanna keep this hidden.")
RULE_REAL(StatBuff, IntelligenceSpellDamageMult, 0.01, "This Number * Intelligence is a multiplier to magic damage.")
RULE_REAL(StatBuff, WisdomHealAmountMult, 0.01, "This Number * Wisdom is a multiplier to healing.")
RULE_REAL(StatBuff, StaminaMitigation, 0.01, "(This Number * Stamina + 1) * Health is your eHP. Dont spend it all in one place.")
RULE_REAL(StatBuff, StaminaPetHPMult, 0.01, "(This Number * Stamina + 1) * Health is your pets HP multiplier. Dont spend it all in one place.")
RULE_REAL(StatBuff, RegenPrcPerHP, 1, "Health * number / 100 is your baseline hp regen.")
RULE_CATEGORY_END()
...
RULE_INT(Spells, BaseCritChance, 7, "Base percentage chance that everyone has to crit a spell")
RULE_INT(Spells, BaseCritRatio, 150, "Base percentage bonus to damage on a successful spell crit. 100=2xdamage")
...
RULE_INT(Spells, HealAmountMessageFilterThreshold, 2000, "Lifetaps below this threshold will not have a message sent to the client (Heal will still process) 0 to Disable.")
...
RULE_REAL(Combat, AERampageMaxDistance, 125, "Max AERampage range (% of max combat distance)")
...
RULE_INT(Combat, MeleeCritDifficulty, 10000, "Value against which is rolled to check if a melee crit is triggered. Lower is easier")
RULE_INT(Combat, ArcheryCritDifficulty, 5000, "Value against which is rolled to check if an archery crit is triggered. Lower is easier")
RULE_INT(Combat, ThrowingCritDifficulty, 2500, "Value against which is rolled to check if a throwing crit is triggered. Lower is easier")
RULE_BOOL(Combat, NPCCanCrit, true, "Setting whether an NPC can land critical hits")
...
RULE_BOOL(Combat, OneProcPerWeapon, false, "If enabled, One proc per weapon per round")
RULE_BOOL(Combat, ProjectileDmgOnImpact, false, "If enabled, projectiles (i.e. arrows) will hit on impact, instead of instantly")
...
RULE_BOOL(Combat, NPCtoNPCPush, true, "Disabled prevents NPC to NPC pushing per the 2013+ patch.")
RULE_BOOL(Combat, UseLiveCombatRounds, false, "Turn this false if you don't want to worry about fixing up combat rounds for NPCs")
...
RULE_INT(NPC, NPCHasteCap, 1000, "Haste cap for non-v3(over haste) haste")
RULE_INT(NPC, NPCHastev3Cap, 250, "Haste cap for v3(over haste) haste")
RULE_CATEGORY_END()
...
RULE_BOOL(Aggro, AggroPlayerPets, true, "If enabled, NPCs will aggro player pets")
...
RULE_CATEGORY(AA)
RULE_INT(AA, ExpPerPoint, 100000, "AAexp precision. Round up to the nearest precision.")
...
RULE_INT(AA, NormalizedAANumberOfWhiteConPerAA, 25, "The number of white con kills per AA point, more or less unused.")
