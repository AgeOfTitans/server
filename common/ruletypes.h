...
RULE_CATEGORY(Quest)
RULE_BOOL(Quest, QuestRarityEnabled, true, "Enable or Disable higher rarity turnins and rewards.")
RULE_REAL(Quest, NormalRewardChance, 20.0, "Drop chance for normal items")
RULE_REAL(Quest, UncommonRewardChance, 20.0, "Drop chance for uncommon items")
RULE_REAL(Quest, RareRewardChance, 20.0, "Drop chance for rare items")
RULE_REAL(Quest, EpicRewardChance, 20.0, "Drop chance for epic items")
RULE_REAL(Quest, LegendaryRewardChance, 20.0, "Drop chance for legendary items")
RULE_REAL(Quest, FabledRewardChance, 20.0, "Drop chance for fabled items")
RULE_CATEGORY_END()
